                    ...
                    <img src="../assets/img/<?php echo $data['LokasiFile'] ?>" class="card-img-top" title="<?php echo $data['JudulFoto'] ?>" style="height: 12rem;">
                      <div class="card-footer text-center">
                          ...
                          <?php 
                            ...
                            <a href="../config/proses_like.php?FotoID=<?php echo $data['FotoID']?>" type="submit" name="batalsuka"><i class="fa fa-thumbs-up"></i></a>
                            <?php }else{ ?>
                            <a href="../config/proses_like.php?FotoID=<?php echo $data['FotoID']?>" type="submit" name="suka"><i class="fa-regular fa-thumbs-up"></i></a>
                            <?php }
                         ...
                         &thinsp;
                          <?php 
                            ...
                            if (mysqli_num_rows($ceksuka) == 1) { ?>
                            <a href="../config/proses_dislike.php?FotoID=<?php echo $data['FotoID']?>" type="submit" name="batalsuka"><i class="fa-solid fa-thumbs-down"></i></a>
                            <?php }else{ ?>
                            <a href="../config/proses_dislike.php?FotoID=<?php echo $data['FotoID']?>" type="submit" name="suka"><i class="fa-regular fa-thumbs-down"></i></i></a>
                            <?php }
