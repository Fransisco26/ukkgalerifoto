...
<div class="container">
    <div class="row">
        <div class="col-md-4">
         <div class="card mt-2">
            <div class="card-header text-black" style="background-color: #99CCFF;">Tambah Album</div>
            <div class="card-body">
                <form action="../config/aksi_album.php" method="POST">
                  ...
                  <button type="submit" class="btn mt-2" name="tambah" style="background-color: #99CCFF;">Tambah Data</button>
                </form>
             </div>
           </div>
          </div>
        <div class="col-md-8">
            <div class="card mt-2">
                <div class="card-header text-black" style="background-color: #99CCFF;">Data Album</div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>               
    <button type="button" class="btn"style="background-color: #99CCFF;" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['AlbumID'] ?>">
       Edit
      </button>
    ...
    <div class="modal fade" id="hapus<?php echo $data['AlbumID'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <form action="../config/aksi_album.php" method="POST">
            <input type="hidden" name="AlbumID" value="<?php echo $data['AlbumID'] ?>">
            Apakah Yakin Menghapus Data Ini <strong> <?php echo $data['NamaAlbum'] ?> </strong> ?
