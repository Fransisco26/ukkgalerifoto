...
<div class="container">
    <div class="row">
        <div class="col-md-4">
         <div class="card mt-2">
            <div class="card-header text-black" style="background-color: #99CCFF;">Tambah Foto</div>
            <div class="card-body">
                <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                  ...
                  <button type="submit" class="btn  mt-2" style="background-color: #99CCFF;" name="tambah">Tambah Data</button>
                </form>
             </div>
           </div>
          </div>
        <div class="col-md-8">
            <div class="card mt-2">
                <div class="card-header text-black" style="background-color: #99CCFF;">Data Galeri Foto</div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>               
    <button type="button" class="btn" style="background-color: #99CCFF;" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['FotoID'] ?>">
       Edit
      </button>
